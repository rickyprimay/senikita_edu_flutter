...
class _ClassDetailScreenState extends State<ClassDetailScreen> {
  InClassViewModel _viewModel = InClassViewModel();
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        // Trigger content generation when message is sent
                        _viewModel.generateContent(_chatController.text).then((_) {
                          setState(() {
                            // Update the chat with generated content here
                          });
                        });
                      },
                    ),
